using DailyTracker.Domain.Events;
using Microsoft.Extensions.Logging;

namespace DailyTracker.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("DailyTracker Domain Event: {DomainEvent}", notification.GetType().Name);
